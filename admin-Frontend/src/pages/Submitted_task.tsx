...
const SubmittedTask: React.FC = () => {
    ...
    const handleApprove = async () => {
        setApproving(true);
        try {
            const res = await fetch(`${API_URL}/admin_tasks/approve`, {
                method: 'POST',
    ...
    const handleReject = async () => {
        setRejecting(true);
        try {
            const res = await fetch(`${API_URL}/admin_tasks/decline`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ submissionId: currentTask.id }),
            });
    ...
    useEffect(() => {
        ...
        const fetchOverview = async () => {
            try {
                const res = await fetch(`${API_URL}/admin_tasks/task-submissions-overview`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
        ...
        const fetchSubmittedTasks = async () => {
            try {
                const res = await fetch(`${API_URL}/admin_tasks/submitted-tasks`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ token }),
                });
