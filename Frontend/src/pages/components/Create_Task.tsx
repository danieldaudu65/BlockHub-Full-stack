...
const Create_Task: React.FC<PopupProps> = ({ onClose, refresh, type }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(`${API_URL}/project_tasks/add_task`, {
        method: 'POST',
  ...
  return (
    <div className='p-6 m-2 bg-[#151718]'>
      ...
      <div className='my-6'>
        ...
        {
          type === "task" && <div className='flex flex-col'>
            <label className='text-white mb-2'>Task</label>
            <input
              type='text'
        ...
        {
          type === "hash" && <div className='flex flex-col'>
            <label className='text-white mb-2'>Hashtag</label>
            <input
              type='text'
